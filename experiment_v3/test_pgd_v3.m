...
[~,YPredAdv] = adversarialExamples(netMX,mbqVal,epsilon,alpha,numAdvIter,classes);
accAdv = mean(YPredAdv == TValidation);

fileID = fopen('pgd_acc_resnet_18_v3.txt', 'w');

fprintf(fileID, "PGD(Iteration = 30) Validation Report for ResNet-18 V3\n\nAlpha = Epsilon\n\n");
